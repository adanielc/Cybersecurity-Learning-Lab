<template>
  <lab-page-shell
    ...
    secure-hint="La versión segura compara las cabeceras educativas X-Lab-* con el recurso y devuelve 403 si no corresponde."
  ...
  >
    <template #form>
      <v-row>
        ...
        <v-col cols="12" md="3">
          <v-text-field v-model="myUsername" label="Username educativo" outlined dense hide-details="auto" />
        </v-col>
        <v-col cols="12" md="3">
          <v-select v-model="myRole" :items="roles" label="Rol educativo" outlined dense hide-details="auto" />
        </v-col>
        <v-col cols="12" md="3">
